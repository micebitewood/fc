...
public class SilentRunner {
	...
	private HashMap<String, Book> market;
	private HashMap<String, NewOrder> cxrBook;
	private HashMap<String, String> idToSymbol;
	...
	{
		SilentRunner silentRunner = new SilentRunner();
